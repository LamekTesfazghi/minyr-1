...
func TestCountLines (t *testing.T) {
	...
	tests := []test{
		{input: "/home/lamek/minyr/kjevik-temp-celsius-20220318-20230318.csv", want: 16756},
		{input: "/home/lamek/minyr/kjevik-temp-fahr-20220318-20230318.csv", want: 16756},
	}
...
func TestAverage (t *testing.T) {
	type test struct {
	 ...
	 tests := []test{
                {input: "/home/lamek/minyr/kjevik-temp-celsius-20220318-20230318.csv", want: 8.56},
                {input: "/home/lamek/minyr/kjevik-temp-fahr-20220318-20230318.csv", want: 47.4},
        }
...
func TestCelsiusToFahrenheitLine(t *testing.T) {
	...
	want string
     ...
     tests := []test{
	     ...
	     want: "Data er basert paa gyldig data (per 18.03.2023) (CCBY 4.0) fra Meteorologisk institutt (MET);endringen er gjort av LT"},
